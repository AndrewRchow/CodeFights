...
your balance to pass a specific threshold. Of course you don't want to wait
...
year 0: 100; year 1: 120; year 2: 144; year 3: 172.8. Thus, it will take 3
years for your balance to pass the threshold, so the answer is 3.
*/

function depositProfit(deposit, rate, threshold) {
	var counter = 0;
	while(deposit<threshold){
		deposit = deposit*(1+(.01*rate));
		counter++;
	}
	return counter;
}
